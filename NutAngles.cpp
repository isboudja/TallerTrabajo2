...
0, 1, 0, 1, 0, 10, 0, 0, 0
    ...
    Matrix res = Matrix(1,954,v1,954);
    ...
    for (int i = 0; i < N_coeff; i++) {
        arg = (res(1,9*i+1) * l +res(1,9*i+2) * lp + res(1,9*i+3) * F + res(1,9*i+4) * D + res(1,9*i+5) * Om)/(3600 * 180/ M_PI);
        dpsi =dpsi + (res(1,9*i+6) + res(1,9*i+7) * T) * sin(arg);
        deps =deps + (res(1,9*i+8) + res(1,9*i+9) * T) * cos(arg);
    }
    dpsi = 1.0e-5 * dpsi /(3600 * 180 / M_PI);
